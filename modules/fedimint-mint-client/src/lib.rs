...
/// Magic timeout value for [`MintClientModule::spend_notes_with_selector`] that
/// disables automatic OOB spend recovery and terminates the state machine as
/// successful immediately.
pub const OOB_SPEND_NO_TIMEOUT: Duration = Duration::MAX;
...
impl MintClientModule {
    ...
    /// come online and reissue the notes themselves. Use
    /// [`OOB_SPEND_NO_TIMEOUT`] to disable automatic cancellation.
    #[deprecated(
        since = "0.5.0",
                            ...
                            .add_operation_log_entry_dbtx(
                                ...
                                MintOperationMeta {
                                    variant: MintOperationMetaVariant::SpendOOB {
                                        ...
                                        no_timeout: try_cancel_after == OOB_SPEND_NO_TIMEOUT,
                                    },
...
pub struct SpendOOBRefund {
    ...
    /// Empty when the spend used [`OOB_SPEND_NO_TIMEOUT`] and no refund was
    /// attempted.

...
/// The default denomination base (power of two) used to generate the set of
/// e-cash note denominations.
pub const DEFAULT_DENOMINATION_BASE: u16 = 2;

/// Per-instance config gen params for the mint module.
...
impl Default for MintGenParams {
    fn default() -> Self {
        Self {
            denomination_base: DEFAULT_DENOMINATION_BASE,
            fee_consensus: None,
        }
    }
}
